      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold mb-4 text-gray-200">Contato</h3>
          ...
          >
            <h3 className="text-2xl font-bold mb-4 text-gray-200">Disponibilidade</h3>
            <p className="text-gray-400">
        ...
        >
          {/* Bottom Section */}
          <div className="flex flex-col md:flex-row items-center justify-between text-center text-gray-400 gap-6">
